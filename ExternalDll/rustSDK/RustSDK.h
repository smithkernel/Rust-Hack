...
public:
	...
	DWORD64 get_addr();
	bool set_addr(DWORD64 ptr); //åñëè îðóæèå óæå àêòèâíî,âåðíåò false
...
{
public:
	DWORD64 BaseEntityCamera = {0}; //àäðåññ êëàññà êàìåðû(Îáíîâëÿåòñÿ â GOM)
	DWORD64 ObjectClassCamera = { 0 }; //îáüåêò êàìåðû (c êëàññîì Transform 0x8)
